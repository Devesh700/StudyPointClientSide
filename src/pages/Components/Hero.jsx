...
const Hero = () => {
  ...
  return (
    <section className=" text-center p-20 bg-hero text-blue-950">
      <div className="grid justify-center py-8 mx-auto bg-primary-lighter lg:w-6/12 md:w-8/12 sm:w-9/12 w-10/12">
